...
<body>
    ...
    <!-- 画像を入れる時は、enctype記述とtype="file"の記述いる -->
    <form method="POST" action="confirm.php" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textArea type="text" class="form-control" name="content" id="content" aria-describedby="content" rows="4" cols="40"><?= $title ?></textArea>
            <div id="emailHelp" class="form-text">※入力必須</div>
        </div>
        <div class="mb-3">
